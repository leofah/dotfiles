...
if ($BLOCK_INSTANCE) {
    ...
    # use the first availabe running player
    my @players = qx(playerctl --list-all);
    foreach my $player (@players) {
	if (qx(playerctl status --player=$player) eq "Playing\n") {
